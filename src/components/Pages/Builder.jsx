    ...
    <section className="fade-in">
      <div className="builder-hero">
        ...
        <div className="builder-bio">
          Engineered this 5-month zero-to-job-ready challenge to bridge the gap between foundational
      ...
      <div className="interview-grid">
        <div className="interview-card">
          <h4>🎯 Purpose</h4>
          <p>A complete 5-month learning challenge designed for beginners with a DataCamp Classroom subscription. Covers Math, ML, Deep Learning, NLP, LLMs, RAG, and MLOps — everything needed for an entry-level AI/ML Engineer role.</p>
        </div>
        <div className="interview-card">
          <h4>📋 What's Included</h4>
          <ul>
            <li>140 day-by-day study plan</li>
